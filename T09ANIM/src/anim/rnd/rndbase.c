...
VOID NS6_RndInit( HWND hWnd )
{
  ...
  hDC = GetDC(hWnd);
  NS6_hRndDCFrame = CreateCompatibleDC(hDC);
  ReleaseDC(hWnd, hDC);
  ...
  NS6_RndFrameW = 50;
  NS6_RndFrameH = 50;
  NS6_RndCamSet(VecSet(0, 5, 5), VecSet(0, 2, 0), VecSet(0, 1, 0));
}
